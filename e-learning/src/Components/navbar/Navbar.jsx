      ...
      <ul className="navbar-nav topbar-nav ms-md-auto align-items-center">
        ...
        <li className="nav-item topbar-icon dropdown hidden-caret">
          ...
          <ul className="dropdown-menu messages-notif-box animated fadeIn" aria-labelledby="messageDropdown">
            ...
            <li>
              <a className="see-all" href="">See all messages<i className="fa fa-angle-right"></i>
              </a>
            </li>
          </ul>
        </li>
        <li className="nav-item topbar-icon dropdown hidden-caret">
          ...
          <ul className="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
            ...
            <li>
              <a className="see-all" href="">See all notifications<i className="fa fa-angle-right"></i>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li className="nav-item topbar-user dropdown hidden-caret">
          <a className="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
            <div className="avatar-sm">
              <img id="profile-picture-nav" src="assets/img/profile.jpg" alt="..." className="avatar-img rounded-circle" />
            </div>
            <span className="profile-username">
              <span className="op-7">Salut,</span>
              <span className="fw-bold" id="username">User</span>
            </span>
          </a>
          <ul className="dropdown-menu dropdown-user animated fadeIn">
            <div className="dropdown-user-scroll scrollbar-outer">
              <li>
                <div className="user-box">
                  <div className="avatar-lg">
                    <img id="profile-picture-large" src="assets/img/profile.jpg" alt="image profile" className="avatar-img rounded" />
                  </div>
                  <div className="u-text">
                    <h4 id="username-big">User</h4>
                    <p className="text-muted" id="email">email@example.com</p> 
              ...
              <li>
                ...
                <a className="dropdown-item" href="#" id="logout">Deconnexion</a>
              </li>
            </div>
          </ul>
        </li>
