...
import "./Home.css";
import courseone from "../assets/imgs/course-one.png";
import coursetwo from "../assets/imgs/course-two.png";
import coursethree from "../assets/imgs/course-three.png";
import thumb from "../assets/imgs/thumb.png";
import about from "../assets/imgs/about.png";
import seminar from "../assets/imgs/seminar.png";
...
import specialOne from "../assets/imgs/special-one.png";
import specialTwo from "../assets/imgs/special-two.png";
import specialThree from "../assets/imgs/special-three.png";
import robotics from "../assets/imgs/robotics.png";
import graphics from "../assets/imgs/graphics.png";
import uiux from "../assets/imgs/ui-ux.png";
            ...
            <div className="row py-5">
              <div className="col-lg-6 col-sm-12 col-md-12">
                ...
                <form action="" method="post">
                  <div className="boutou-search input-group bg-none ">
                    <input
                      type="password"
                      className="bg-none"
                  ...
                  <div class="carousel-item active">
                    <div className="row">
                      <div className="col-lg-3 col-md-6 col-sm-12 feactures">
                        ...
                        <p>
                          Le matériel de cours pour chaque matière est conçu par
                          des experts
                        </p>
                      </div>
          ...
          <div className="col-lg-8 col-xl-6 text-start">
            <div className="seminar__content">
              ...
              <p>
                ...
                présent au séminaire, vous pourrez facilement décider de choisir
                le cours approprié.
              </p>
            ...
            <div className="col-lg-5 col-xl-6 col-sm-12 text-start">
              <div className="process__content ">
                ...
                <p>
                  ...
                  nécessite des compétences. Et la compétence s’acquiert grâce à
                  une pratique régulière et aux conseils d’experts. Chez
