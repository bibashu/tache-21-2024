...
const Contact = () => {
    ...
    {/* SECTION-BANNIERE END */}
         ...
         <section class="newsletter section bg-img py-5 contact-newsletter">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-sm-12 col-xxl-8">
                        <div class="newsletter-content">
                            <div class="section-header text-center">
                                <h2 class="section-title mb-3">Restez connecté avec Elearning pour rester à jour</h2>
